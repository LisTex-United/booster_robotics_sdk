...
class OdomRepublisher(Node):
    def __init__(self):
        ...
        # Maximum publish frequency (Hz). Will not publish faster than this.
        self.max_hz = 50.0
        self.min_dt = 1.0 / float(self.max_hz)
        self.last_pub_time = None

        self.pose_cov_x = 0.01
        self.pose_cov_y = 0.01
        self.pose_cov_yaw = 0.01

        self.twist_cov_vx = 0.01
        self.twist_cov_vy = 0.01
        self.twist_cov_wz = 0.01
    ...
    def callback(self, msg):
        ...
        # Enforce maximum publish rate: if last publish was too recent, skip publishing
        ...
        # Record publish time so we don't exceed max_hz
